module ProjectRazor
  class Client
    # ProjectRazor API Request Methods.
    module Request
      ...
      def connection(options = {})
        ...
        connection = Faraday.new(connection_options) do |builder|
          ...
          builder.use ProjectRazor::Client::Response::ParseJSON unless options[:raw]
          builder.use ProjectRazor::Client::Response::CloudError
        end
      end
      ...
      def request(method, path, options = {}, payload = nil)
        headers = {}
        headers["User-Agent"] = "razor-client-" + ProjectRazor::VERSION
